                                ...
                                <?php foreach ($keterangan as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-outline-success" href="<?= base_url('keterangan/detail/' . $value->id_keterangan); ?>"><i class="fa fa-info"></i>&nbsp; Detail</a>
                                            <a class="btn btn-outline-warning" href="<?= base_url('keterangan/edit_keterangan/' . $value->id_keterangan); ?>"><i class="fa fa-edit"></i>&nbsp; Edit</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
