            ...
            <div class="col-12">
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="/keterangan/add" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="keperluan" name="keperluan">
                                        <option selected disabled value="">-- Pilih Jenis Surat Keterangan --</option>
                                        ...
                                        <option value="4">Surat Keterangan Satu Nama</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-5">
