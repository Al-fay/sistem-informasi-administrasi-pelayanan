            ...
            <div class="col-12">
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="/kelahiran/add" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>

                            <div class="col-6">
                                <label class="form-label">Nama Anak</label>
                                <input type="text" class="form-control" name="nama_anak" id="nama_anak" autofocus value="<?= old('nama_anak'); ?>">
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <input type="date" class="form-control" name="tgl_kelahiran" value="<?= old('tgl_kelahiran'); ?>">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" name="tempat_kelahiran" value="<?= old('tempat_kelahiran'); ?>">
                            </div>
                            <div class="col-6">
