                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($pindah as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                if ($value->surat_pindah == '') {
                                                    echo '<button type="button" class="btn btn-outline-info my-1" disabled><i class=" fa fa-file-download"></i>&nbsp; Unduh</button>';
                                                } else {
                                                    echo '<a class="btn btn-outline-info my-1" href="' . base_url("pindah/unduh/" . $value->id_pindah) . '"><i class="fa fa-file-download"></i>&nbsp; Unduh</a>';
                                                }
                                                ?>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($pindah_user as $key => $value) { ?>
                                        <tr>
                                            <th scope="row" class="text-center"><?= $i++; ?></th>
                                            <td><?= date('d-m-Y', strtotime($value->tanggal)) ?></td>
                                            <td><?= $value->nama; ?></td>
                                            ...
                                            <td>
                                                ...
                                                if ($value->surat_pindah == '') {
                                                    ...
                                                    echo '<a class="btn btn-outline-danger my-1 btn-sm" href="' . base_url("pindah/unduh/" . $value->id_pindah) . '"><i class="fa fa-file-download"></i>&nbsp; Unduh</a>';
                                                }
                                                ?>

                                                <a class="btn btn-outline-success my-1 btn-sm" href="<?= base_url('pindah/detail/' . $value->id_pindah); ?>"><i class="fa fa-info"></i>&nbsp; Detail</a>

                                                <a class="btn btn-outline-warning my-1 btn-sm" href="<?= base_url('pindah/edit_pindah/' . $value->id_pindah); ?>"><i class="fa fa-edit"></i>&nbsp; Edit</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
